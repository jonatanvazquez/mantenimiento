...
class Db {
	...
	valida_ingreso(opciones){
		r.table('user').filter(opciones).pluck('rol').run(connect(), function(err, result){
			if(err){
...
module.exports.getTableBy = getTableBy
...
module.exports.getUserByRol = getUserByRol
module.exports.getComponente = getComponente
module.exports.getMaquinas = getMaquinas
module.exports.acentuarMantenimiento = acentuarMantenimiento
module.exports.listarMantenimientos = listarMantenimientos
module.exports.listarMantenimientosFiltro = listarMantenimientosFiltro
module.exports.listarMaquinasFiltro = listarMaquinasFiltro
module.exports.eliminarComponente = eliminarComponente
module.exports.eliminarMaquina = eliminarMaquina
module.exports.updateMantenimiento = updateMantenimiento
module.exports.updateMaquina = updateMaquina
